package CCNQ::Actions::b2bua::client_all_sbc;
...
<X-PRE-PROCESS cmd="include" data="template/client-all-sbc.xml"/>
EOT
...
'CCNQ::Actions::b2bua::client_all_sbc';
