...
function(doc) {
  ...
  if(doc.followme)
  {
    ...
    var xml =
      ...
      // My version of FreeSwitch/spidermonkey started misteriously saying "mod_spidermonkey.c:2765 new_js_session() Read Lock Failure." and "confirm.js:21 mod_spidermonkey()  TypeError: session.getVariable is not a function",
      // so call-confirmation is gone for now.
      ...
      "<action application=\"bridge\" data=\"{hangup_after_bridge=true"+bypass_media+"}"+target+"\"/>";
